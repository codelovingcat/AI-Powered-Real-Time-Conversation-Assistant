...
public sealed class ConversationInputValidator
{
    ...
    public void ValidateCreate(CreateConversationCommand command)
    {
        ...
        ValidateOptionalText(errors, "title", command.Title, Conversation.TitleMaxLength);
        ValidateRequiredText(errors, "instruction", command.Instruction, Conversation.InstructionMaxLength);
    ...
    public void ValidateUpdate(UpdateConversationCommand command)
    {
        ...
        if (command.Title is not null)
            ValidateRequiredText(errors, "title", command.Title, Conversation.TitleMaxLength);
    ...
    public void ValidateProcess(ProcessConversationInputCommand command)
    {
        ...
        ValidateRequiredText(errors, "text", command.Text, Message.TextMaxLength);
